...
#     #BoredApeTronClub #1938 has been bought for 5,000 
#     TRX
#     #181.516956$

#     https://tronscan.org/#/transaction/0e69e79d5623a471f306b3ceb39a966ed5946213648d193deddb5739d115cdfa
...
# res=requests.post("https://api.telegram.org/bot1997316336:AAHpwbMLpH1MQ_zzfJ4V2B0UtQhH3V94EAg/sendPhoto?chat_id={}&caption= {}".format(chat_id,message_),files=files)
...
# def send_message(chat_id,message):
#     files={'photo':open('/home/kwamena/SmartCOntract/image.png','rb')}
#     res=requests.post('https://api.telegram.org/bot1997316336:AAHpwbMLpH1MQ_zzfJ4V2B0UtQhH3V94EAg/sendPhoto?chat_id=-1001277267102 &caption=%s'[message_],files=files)


# send_message(chat_id,message_)
...
from telegram_NFT import Link_
from selenium import webdriver
from bs4 import BeautifulSoup
import time
import json
...
def msg(token,trx,converted,link_):
    message=("""
    #BoredApeTronClub #{} has been bought for {}
    #{}$
